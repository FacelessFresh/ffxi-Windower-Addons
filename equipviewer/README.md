** This is a File Edit that makes it so the box for Equipviewer don't show up on the character login screen. Just copy over the Equipviewer.lua in the equipviewer folder.
