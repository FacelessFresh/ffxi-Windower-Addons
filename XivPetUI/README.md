# This is the Tylas Code for the older xivparty addon that had pet support, I removed the display of other party members and edited a layout to try to resemble the sleek layout from the newer xivparty layout. the tp don't fill up quite the same but the ui looks a little similar. Couldn't get the size 100% but it at least works compared to the luck i had with petbar. Also I've tested a bit and tried to get luopans to display a hp bar but no luck, it at least will show you have a luopan up. Haven't quite figured out how to get it to display info for luopans yet.
